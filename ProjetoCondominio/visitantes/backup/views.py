...
class VisitanteCreateView(CreateView):
    ...
    success_url = reverse_lazy('visitantes:visitante_list') # Redireciona para a lista de visitantes após criar um novo visitante   
    
class VisitanteUpdateView(UpdateView):
    model = Visitante
    form_class = VisitanteForm
    template_name = 'visitantes/visitante_form.html'
    success_url = reverse_lazy('visitantes:visitante_list') # Redireciona para a lista de visitantes após atualizar um visitante
    
class VisitanteDeleteView(DeleteView):
    model = Visitante
    template_name = 'visitantes/visitante_confirm_delete.html'
    success_url = reverse_lazy('visitantes:visitante_list') # Redireciona para a lista de visitantes após excluir um visitante  
